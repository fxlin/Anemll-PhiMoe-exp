'''
from transformers: src/transformers/modeling_rope_utils.py

quick hack to make it work. 
to support more models, need to also port PretrainedConfig from transformers (configuration_utils.py)
which is tons of code ....
fxl, 4/25/25
'''
...
def _validate_longrope_parameters(config, ignore_keys: Optional[set] = None):
    rope_scaling = config.rope_scaling
    rope_type = rope_scaling.get("rope_type", rope_scaling.get("type", None))  # BC: "rope_type" was originally "type"
